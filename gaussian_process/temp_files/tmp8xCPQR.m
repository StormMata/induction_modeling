...
save( '/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpiRgCfp.out', 'hyp_opt', 'best_nll', 'nlls', 'hessian' );
% exit();

fprintf('\nWriting completion flag\n');
ID = fopen('/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpH8VW1a.flg', 'w');
