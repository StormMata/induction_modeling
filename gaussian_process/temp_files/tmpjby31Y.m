...
covfunc = {@covProd, {{@covMask, {[1 0 0], {@covSum, {@covConst, @covLINscaleshift}}}}, {@covSum, {{@covProd, {{@covMask, {[1 0 0], {@covPeriodic}}}, {@covMask, {[0 0 1], {@covSEiso}}}}}, {@covProd, {{@covMask, {[0 1 0], {@covSEiso}}}, {@covMask, {[0 0 1], {@covSEiso}}}}}}}}}
hyp.cov = [ -7.4169947037766635 -2.8131701844250414 0.7332562293907455 -0.5813888111391353 1.77595778568622 1.9630350056839216 0.5762744263532523 -3.0301121188821463 -4.644952387504164 -8.496610176678828 -1.4775497132760147 2.5071465361350755 ]
...
save( '/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpNvgNRM.out', 'hyp_opt', 'best_nll', 'nlls', 'hessian' );
% exit();

fprintf('\nWriting completion flag\n');
ID = fopen('/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpioMi_6.flg', 'w');
