...
hyp.cov = [ -10.246973205831605 -1.7873450146504848 0.6480709529372004 -0.5813888111391353 1.77595778568622 1.9630350056839216 0.5762744263532523 -3.0301121188821463 -4.644952387504164 -8.496610176678828 -1.4775497132760147 2.5071465361350755 ]
...
save( '/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpnght25.out', 'hyp_opt', 'best_nll', 'nlls', 'hessian' );
% exit();

fprintf('\nWriting completion flag\n');
ID = fopen('/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpBlwxFt.flg', 'w');
