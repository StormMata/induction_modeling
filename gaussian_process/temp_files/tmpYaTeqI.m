...
covfunc = {@covSum, {{@covProd, {{@covMask, {[1 0 0], {@covSum, {@covConst, @covLINscaleshift}}}}, {@covMask, {[0 1 0], {@covPeriodic}}}, {@covMask, {[0 0 1], {@covSEiso}}}}}, {@covProd, {{@covMask, {[0 0 1], {@covSEiso}}}, {@covMask, {[0 0 1], {@covPeriodic}}}, {@covSum, {{@covProd, {{@covMask, {[1 0 0], {@covSEiso}}}, {@covMask, {[0 0 1], {@covSEiso}}}}}, {@covMask, {[0 1 0], {@covSEiso}}}}}}}}}
hyp.cov = [ -2.013604193939733 -0.9073068474057846 0.9395039122099283 2.4984568562691156 -2.1114162834493304 1.002132373567421 -0.17693735979545538 -2.309079754720957 -1.0430937690338333 0.43353057634698333 3.1583998709951464 -1.4802292731591509 -2.073615959788093 -3.210388776795705 -4.170475674438063 0.0 0.0 -6.007038736007914 -6.399749246668841 ]
...
save( '/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpRVhG1J.out', 'hyp_opt', 'best_nll', 'nlls', 'hessian' );
% exit();

fprintf('\nWriting completion flag\n');
ID = fopen('/scratch/09909/smata/induction_modeling/gaussian_process/temp_files/tmpR24H0s.flg', 'w');
